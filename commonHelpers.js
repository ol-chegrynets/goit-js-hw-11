...
</li>`}const g="/goit-js-hw-11/assets/close-784344e5.svg",d=document.querySelector(".search-form"),l=document.querySelector(".gallery"),n=document.querySelector(".loader"),y=new u(".gallery a",{captionsData:"alt",captionDelay:350});d.addEventListener("submit",L);function L(e){e.preventDefault();const s=e.target.elements.searchField.value.trim();if(l.innerHTML="",s===""){c("You forgot enter data for search","#ffa000");return}n.classList.remove("visually-hidden"),f(s).then(a=>{if(a.hits.length===0)l.innerHTML="",c("Sorry, there are no images matching your search query. Please try again!","#EF4040");else{const r=m(a.hits);l.innerHTML=r,y.refresh()}n.classList.add("visually-hidden")}).catch(a=>{c("An error occurred while fetching photos. Please try again later.","#EF4040"),n.classList.add("visually-hidden")}),d.reset()}function c(e,s){h.show({message:e,position:"topRight",backgroundColor:s,iconUrl:g,messageColor:"#fff",theme:"dark",maxWidth:"350px"})}
